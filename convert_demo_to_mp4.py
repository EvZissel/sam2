...
def main():
    ...
    # upload damo
    file_name = 'peg_insert_20_demos_20_trials_pose_id_10_2024-12-05_14-50-33'
    ...
    save_observations(observations, name=f"./transitions/{file_name}_next_observations.mp4")
